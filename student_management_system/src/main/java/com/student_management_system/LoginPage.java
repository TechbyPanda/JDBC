...
import com.student_management_system.DAO.*;
...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 255, 204), new java.awt.Color(0, 0, 0)));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        loginModel model = new loginModel(n,p);
        boolean status = loginDAO.check(model);
        
        if(username.getText().equals("") || password.getText().equals(""))
            JOptionPane.showMessageDialog(this, "please fill login page.");
        else if(status)
        {
            ...
            MainForm.jLabel_stdCount.setText(Integer.toString(CountFunction.countData("user")));
            this.dispose();
        }
        else
