...
public class UpdateForm extends javax.swing.JFrame {
    ...
    public UpdateForm() {
        ...
        tMale.setEnabled(false);
        tFemale.setEnabled(false);
        tAnother.setEnabled(false);
    ...
    private void initComponents() {
        ...
        tAnother = new javax.swing.JRadioButton();
        ...
        jPanel3.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 270, -1, -1));
        ...
        jPanel3.add(tAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 300, 438, -1));
        ...
        jPanel3.add(btnCreate, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 470, 88, -1));
        ...
        jPanel3.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(17, 13, -1, 510));

        jTextField1.setText("Enter only Account No");
        jPanel3.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 10, 220, -1));
        ...
        jPanel3.add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 10, -1, -1));

        tMale.setText("male");
        tMale.setOpaque(false);
        jPanel3.add(tMale, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 50, -1, -1));

        tFemale.setText("female");
        tFemale.setOpaque(false);
        jPanel3.add(tFemale, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 50, -1, -1));

        tAnother.setText("another");
        tAnother.setOpaque(false);
        jPanel3.add(tAnother, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 50, -1, -1));
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if(name.isEmpty() || lname.isEmpty() || fname.isEmpty() || gender == null || address.isEmpty() || mobile.isEmpty() || Email.isEmpty() )
        JOptionPane.showMessageDialog(this, "Please complete the form");
        else{
            if(Checker.isValidData(mobile, name,2000, Email)){
                AccountModel model = new AccountModel(acc,fname, gender, DOB, address, mobile, Email, name, lname);
                boolean status = AccountDAO.update(model);
                if(status){
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
       AccountModel am = AccountDAO.getAccountDetails(jTextField1.getText());
        
        firstName.setEnabled(true);
        lastName.setEnabled(true);
        tFather.setEnabled(true);
        tEmail.setEnabled(true);
        tMobile.setEnabled(true);
        tAddress.setEnabled(true);
        tMale.setEnabled(true);
        tFemale.setEnabled(true);
        tAnother.setEnabled(true);
        date_chooser.setEnabled(true);
        firstName.setText(am.getFname());
        lastName.setText(am.getLname());
        tFather.setText(am.getFatherName());
        tEmail.setText(am.getEmail());
        tMobile.setText(am.getMobile());
        tAddress.setText(am.getAddress());
        if(am.getGender().equals("m"))
            tMale.setSelected(true);
        else if(am.getGender().equals("f"))
            tFemale.setSelected(true);
        else if(am.getGender().equals("t"))
            tAnother.setSelected(true);
    ...
    private javax.swing.JRadioButton tAnother;
